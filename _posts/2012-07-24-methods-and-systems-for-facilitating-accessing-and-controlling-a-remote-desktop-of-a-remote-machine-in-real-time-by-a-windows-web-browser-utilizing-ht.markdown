...
means for forming an image file based on the updated portion of the bitmap wherein the image file is HTML5 compatible and
...
wherein the drawing update represents a portion of the image of the remote desktop wherein the web browser comprises client script code 
...
23. The apparatus of clause 22 wherein the web browser comprises a windows web browser and means for translating the remote desktop drawing command comprises means for translating the remote desktop drawing command into a windows graphics drawing command 
...
facilitating providing the web browser drawing update from the web server to the web browser of the client device utilizing HTTP as a response to at least one of the plurality of drawing requests from the web browser 
